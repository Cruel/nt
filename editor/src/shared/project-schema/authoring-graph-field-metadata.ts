...
const EXPLICIT_FIELD_EFFECTS: readonly [RegExp, AuthoringFieldGraphEffect][] = Object.freeze([
  ...
  [/^\/localization\/orphanedMessages(?:\/|$)/, NONE],
  ...
  [
    /^\/localization\/translations\/\*\/\*\/(?:acknowledgedGuidanceFingerprint|acknowledgedPresentationFingerprint|model|origin|provider|review|sourceFingerprint|text|useSource)$/,
    valueDependent('localization-catalog-entry'),
  ],
  [
  ...
  // genuinely new canonical leaves, so classify them explicitly instead of shifting the preserved
  // pre-cutover review sequence.
...
const legacySchemaLeafPaths = [
  ...
  ...([
    '/shaders/*/data/displayName',
    '/shaders/*/data/kind',
    '/shaders/*/data/roleBindings/*/fragmentShader/$ref/collection',
    '/shaders/*/data/roleBindings/*/fragmentShader/$ref/id',
    '/shaders/*/data/roleBindings/*/role',
    '/shaders/*/data/roleBindings/*/vertexShader/$ref/collection',
    '/shaders/*/data/roleBindings/*/vertexShader/$ref/id',
    '/shaders/*/data/roles/*',
    '/shaders/*/data/samplers/*/binding',
    '/shaders/*/data/samplers/*/name',
    '/shaders/*/data/samplers/*/type',
    '/shaders/*/data/stages/*/compiled/*/byteHash',
    '/shaders/*/data/stages/*/compiled/*/byteSize',
    '/shaders/*/data/stages/*/compiled/*/compileInputFingerprint',
    '/shaders/*/data/stages/*/compiled/*/path',
    '/shaders/*/data/stages/*/sourceAsset/$ref/collection',
    '/shaders/*/data/stages/*/sourceAsset/$ref/id',
    '/shaders/*/data/stages/*/sourceMode',
    '/shaders/*/data/stages/*/sourceText',
    '/shaders/*/data/stages/*/stage',
    '/shaders/*/data/uniforms/*/binding',
    '/shaders/*/data/uniforms/*/default',
    '/shaders/*/data/uniforms/*/default/*',
    '/shaders/*/data/uniforms/*/default/a',
    '/shaders/*/data/uniforms/*/default/b',
    '/shaders/*/data/uniforms/*/default/g',
    '/shaders/*/data/uniforms/*/default/r',
    '/shaders/*/data/uniforms/*/label',
    '/shaders/*/data/uniforms/*/name',
    '/shaders/*/data/uniforms/*/range/*',
    '/shaders/*/data/uniforms/*/type',
    '/shaders/*/description',
    '/shaders/*/id',
    '/shaders/*/label',
  ] as JsonPointer[]),
  // #294 also replaces the previous Material/Script leaves below. Retain their old paths only for
  // review-code alignment; the canonical replacement leaves are classified explicitly above.
  ...([
    '/materials/*/data/baseMaterialId',
    '/materials/*/data/role',
    '/materials/*/data/shader/$ref/collection',
    '/materials/*/data/shader/$ref/id',
    '/materials/*/data/textures/*/sampler',
    '/materials/*/data/uniforms/*/name',
    '/materials/*/data/uniforms/*/value',
    '/materials/*/data/uniforms/*/value/*',
    '/materials/*/data/uniforms/*/value/a',
    '/materials/*/data/uniforms/*/value/b',
    '/materials/*/data/uniforms/*/value/g',
    '/materials/*/data/uniforms/*/value/r',
    '/scripts/*/data/source/asset/$ref/collection',
    '/scripts/*/data/source/asset/$ref/id',
    '/layouts/*/data/lua/sourceAsset/$ref/collection',
    '/layouts/*/data/lua/sourceAsset/$ref/id',
