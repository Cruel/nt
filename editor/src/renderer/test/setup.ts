...
Object.defineProperty(window, 'noveltea', {
  value: {
    ...
    previewExportedPackage: vi.fn().mockResolvedValue({
      ok: false,
      success: false,
      diagnostics: [
        {
          severity: 'warning',
          category: 'preview',
          path: '/mock/project/export.ntpkg',
          message: 'Package preview is not wired yet.',
        },
      ],
    }),
    ...
    ensureTerminalState: vi.fn().mockResolvedValue({
      sessions: [
        {
      ...
      selectedSessionId: '00000000-0000-4000-8000-000000000001',
    }),
    createTerminalSession: vi.fn(),
    selectTerminalSession: vi.fn(),
    closeTerminalSession: vi.fn(),
    relaunchTerminalSession: vi.fn(),
    writeTerminal: vi.fn().mockResolvedValue(undefined),
    resizeTerminal: vi.fn().mockResolvedValue(undefined),
    showTerminalNotification: vi.fn().mockResolvedValue(true),
    onTerminalEvent: vi.fn().mockReturnValue(() => {}),
    onTerminalNotificationClick: vi.fn().mockReturnValue(() => {}),
    ...
    runUiPlaybackSpec: vi.fn().mockResolvedValue({
      ok: true,
      report: { id: 'smoke', passed: true, observations: [], trace: [] },
      diagnostics: [],
    }),
    exportPackage: vi.fn().mockResolvedValue({
      ...
      diagnostics: [],
      byteCount: 1,
      manifest: { format: 'noveltea.runtime-package', entries: [] },
      checksums: {},
    }),
    stagePlatformExport: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      cancelled: false,
      operationId: 'mock',
    ...
    exportProjectToPlatform: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      cancelled: false,
      operationId: 'mock',
    ...
    getComfyUiQueue: vi.fn().mockResolvedValue({
      promptId: null,
      workflowId: null,
      state: 'idle',
      queueRemaining: 0,
    ...
    copyComfyUiWorkflow: vi
      .fn()
      .mockResolvedValue({ ok: true, success: true, action: 'copied', diagnostics: [] }),
    deleteComfyUiWorkflow: vi
      .fn()
      .mockResolvedValue({ ok: true, success: true, deleted: [], diagnostics: [] }),
    renameComfyUiWorkflow: vi.fn().mockResolvedValue({ ok: true, success: true, diagnostics: [] }),
    importComfyUiWorkflowToLibrary: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      diagnostics: [],
    ...
    repairComfyUiWorkflowInLibrary: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      diagnostics: [],
      workflowKey: 'user:mock.manifest.json',
    ...
    verifyComfyUiWorkflowLibrary: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      checkedAt: 'now',
      verified: [],
    ...
    analyzeComfyUiWorkflowImport: vi
      .fn()
      .mockResolvedValue({ ok: true, diagnostics: [], roleCandidates: {} }),
    generateComfyUiImage: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      promptId: 'prompt-1',
      diagnostics: [],
    ...
    editComfyUiImage: vi.fn().mockResolvedValue({
      ok: true,
      success: true,
      promptId: 'prompt-2',
      diagnostics: [],
      assets: [
        {
          asset: {
            originalPath: 'comfyui:edit.png',
            originalName: 'edit.png',
            projectRelativePath: 'assets/generated/edit.png',
            kind: 'image',
            extension: '.png',
            mimeType: 'image/png',
            byteSize: 4,
            contentHash: 'sha256:mock-edit',
            importedAt: 'now',
          },
          previewUrl: 'data:image/png;base64,ZWRpdA==',
          absolutePath: '/mock/project/assets/generated/edit.png',
          projectRelativePath: 'assets/generated/edit.png',
          promptId: 'prompt-2',
