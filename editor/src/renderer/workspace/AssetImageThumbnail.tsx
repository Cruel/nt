...
export function AssetImageThumbnail({
  ...
  useEffect(() => {
    ...
    void window.noveltea
      .resolveProjectAssetUrl(projectFilePath, sourcePath)
      .then((result) => {
  ...
  return (
    <span
      className={`flex shrink-0 items-center justify-center overflow-hidden rounded border bg-muted/20 ${className}`}
    >
      {assetUrl ? (
