...
export const collectionVisuals: Record<AuthoringCollectionKey, VisualIdentity> = {
  ...
  itemDefinitions: { icon: PackageOpen, colorClassName: 'text-yellow-700 dark:text-yellow-300' },
  itemStacks: { icon: Coins, colorClassName: 'text-yellow-600 dark:text-yellow-400' },
