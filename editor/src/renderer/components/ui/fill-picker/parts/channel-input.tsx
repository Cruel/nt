...
import { colorChannels, setColorChannel, type ChannelDescriptor } from '../lib/channels';
...
export interface ChannelInputProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange'> {
