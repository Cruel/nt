...
export interface ChromaProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onKeyDown'> {
  orientation?: 'horizontal' | 'vertical';
}

export const Chroma = React.forwardRef<HTMLDivElement, ChromaProps>(function Chroma(
