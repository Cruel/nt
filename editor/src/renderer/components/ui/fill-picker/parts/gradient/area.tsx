...
export const Area = React.forwardRef<HTMLDivElement, AreaProps>(function Area(
  ...
  const cssBackground = React.useMemo(() => formatGradient(ctx.gradient), [ctx.gradient]);
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="absolute inset-0" style={{ backgroundImage: CHECKERBOARD_LG }} />
      <div aria-hidden className="absolute inset-0" style={{ background: cssBackground }} />
