...
import { useGradientPicker, type UseGradientPickerProps } from '../../hooks/use-gradient-picker';
...
export const Root = React.forwardRef<HTMLDivElement, RootProps>(function Root(
  { value, defaultValue, onValueChange, defaultStopColorFormat, className, children, ...rest },
  ref,
) {
