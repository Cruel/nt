...
export const ShapeSwitcher = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  function ShapeSwitcher({ className, ...rest }, ref) {
    ...
    return (
      <div
        ...
        className={cn('inline-flex w-full rounded-md bg-muted p-0.75 gap-0.5', className)}
        {...rest}
      >
