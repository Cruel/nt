...
export const RadiusInput = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
      ...
      >
        <FieldInputGroup>
          ...
          <FieldInput
            ...
            onChange={onChange}
            aria-label={
              usePercent ? 'Circle radius as percent of Area width' : 'Circle radius in pixels'
            }
            className="w-12"
          />
