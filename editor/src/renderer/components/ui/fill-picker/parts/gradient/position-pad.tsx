...
export const PositionPad = React.forwardRef<HTMLDivElement, PositionPadProps>(function PositionPad(
  ...
  const onKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
    ...
    e.preventDefault();
    ctx.setCenter(next);
    announce(`x ${Math.round(next.x * 100)}%, y ${Math.round(next.y * 100)}%`);
  };
