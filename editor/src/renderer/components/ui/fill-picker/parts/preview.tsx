...
export const Preview = React.forwardRef<HTMLDivElement, PreviewProps>(function Preview(
  ...
  return (
    <div
      ...
      className={cn('relative size-10 shrink-0 overflow-hidden rounded-md', SAMPLE_EDGE, className)}
      style={{
      ...
      {...rest}
    >
      <div aria-hidden="true" className="absolute inset-0" style={{ background: bg }} />
      <div aria-hidden="true" className="absolute inset-0" style={{ background: fg }} />
    </div>
  );
});
