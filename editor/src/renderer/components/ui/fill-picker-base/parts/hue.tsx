...
import { hslHue, hsbHue } from '@/components/ui/fill-picker/lib/color';
import { setHueFromSlider } from '@/components/ui/fill-picker/lib/channels';
...
export interface HueProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'defaultValue'> {
