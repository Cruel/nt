...
const TYPE_ITEMS = Object.fromEntries(TYPES.map((t) => [t.value, t.label])) as Record<
  GradientType,
  string
>;
 ...
 */
export const TypeSwitcher = React.forwardRef<HTMLButtonElement, { className?: string }>(
