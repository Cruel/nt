...
import { useGradientPickerContext } from '@/components/ui/fill-picker/contexts/gradient';
import type { GradientInterp } from '@/components/ui/fill-picker/lib/gradient';
...
const INTERP_ITEMS = Object.fromEntries(OPTIONS.map((o) => [o.value, o.label])) as Record<
  GradientInterp,
  string
>;
 ...
 */
export const InterpSwitcher = React.forwardRef<HTMLButtonElement, InterpSwitcherProps>(
      ...
      <span className="flex w-full items-center gap-2">
        ...
        <Tooltip.Root>
          ...
          <Tooltip.Portal>
            ...
            <Tooltip.Positioner side="right" align="center" sideOffset={4} className="z-50">
              <Tooltip.Popup
                className={cn(
