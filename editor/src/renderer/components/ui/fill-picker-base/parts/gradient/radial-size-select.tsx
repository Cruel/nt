...
export const RadialSizeSelect = React.forwardRef<HTMLButtonElement, RadialSizeSelectProps>(
...
function RowWithInfo({ value, description }: { value: string; description: string }) {
  return (
