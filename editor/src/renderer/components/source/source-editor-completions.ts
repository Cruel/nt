...
export const luaRuntimeCompletions: Completion[] = [
  ...
  'noveltea.presentation.set_material_parameter',
  'noveltea.presentation.bind_material_parameter',
  'noveltea.presentation.clear_material_parameter',
  'noveltea.presentation.material_parameter',
  'noveltea.presentation.set_postprocess',
  'noveltea.presentation.clear_postprocess',
  'noveltea.presentation.postprocess',
  'noveltea.text_log',
