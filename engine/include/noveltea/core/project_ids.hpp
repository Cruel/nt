...
inline constexpr std::string_view system_font_alias = "sys";
inline constexpr std::string_view system_icon_font_alias = "sysIcon";
inline constexpr std::string_view system_font_file = "LiberationSans.ttf";
inline constexpr std::string_view system_icon_font_file = "fontawesome.ttf";
