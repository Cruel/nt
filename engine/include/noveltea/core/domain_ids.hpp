...
NOVELTEA_DOMAIN_ID(SceneInputId);
NOVELTEA_DOMAIN_ID(SceneOutcomeId);
...
NOVELTEA_DOMAIN_ID(CharacterPresentationProfileId);
NOVELTEA_DOMAIN_ID(CharacterPresentationLayerId);
NOVELTEA_DOMAIN_ID(CharacterPoseId);
NOVELTEA_DOMAIN_ID(CharacterExpressionId);
NOVELTEA_DOMAIN_ID(CharacterAppearanceId);
NOVELTEA_DOMAIN_ID(CharacterIdleId);
NOVELTEA_DOMAIN_ID(CharacterAnimationClipId);
NOVELTEA_DOMAIN_ID(CharacterGestureId);
NOVELTEA_DOMAIN_ID(CharacterGestureCueId);
NOVELTEA_DOMAIN_ID(CharacterGestureEventId);
