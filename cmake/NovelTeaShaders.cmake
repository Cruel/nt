...
function(noveltea_find_shader_tools)
    ...
    if(NOT _bgfx_include AND NOVELTEA_BGFX_SOURCE_DIR AND
       EXISTS "${NOVELTEA_BGFX_SOURCE_DIR}/bgfx/src/bgfx_shader.sh")
        set(_bgfx_include "${NOVELTEA_BGFX_SOURCE_DIR}/bgfx/src")
    endif()
