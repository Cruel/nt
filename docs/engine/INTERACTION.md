...
- **Authoring version 3:** collection-specific Interaction records with optional `extends`, typed properties, ordered rules, exact/wildcard operands, generic/exact-hotspot context, and strict programs.
