...
| `workspace` | Sidebar utility labels, command palette strings, bottom panel labels, basic empty states, shared Property Manager UI, Project Settings ComfyUI workflow management | Source | Machine-unreviewed | Pseudo |
