...
- `nt-active-text`: registered as a C++ RmlUi element. Phase 5 binds room/dialogue/cutscene body state into safe fallback RML. Rich-text layout, reveal, per-glyph effects, and tweened animation are Phase 7 work.
