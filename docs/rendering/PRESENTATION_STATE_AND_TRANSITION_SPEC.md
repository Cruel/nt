...
- background, actor, prop, environment, Interactable runtime Material selection and scoped Material
  Parameters, postprocess effects, Layout, Map-underlay, text/choice, and desired-audio intent;
