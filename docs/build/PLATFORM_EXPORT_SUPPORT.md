...
| Web | wasm32, single-threaded | Deployment directory/ZIP | WebGL 2; `essl-300` (legacy variants remain template-declared) | Any host with an installed template | Supported browser floor provisional; threaded Web is a separate future template |
